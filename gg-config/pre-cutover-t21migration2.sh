#!/bin/bash
# Pre-Cutover Validation for migration: t21migration2
# Auto-generated by Terraform. Run before executing switchover.
set -e
MIGRATION_ID="ocid1.odmsmigration.oc1.iad.amaaaaaarsnyneya6b5alwmx7jxkdieixrnylvvg7zxorzshs5bspmd2xkua"
MAX_LAG=30
echo "============================================"
echo " Pre-Cutover Validation: t21migration2"
echo "============================================"
echo ""
...
echo ""
echo "============================================"
echo " All pre-cutover checks passed for t21migration2"
