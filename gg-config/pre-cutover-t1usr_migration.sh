#!/bin/bash
# Pre-Cutover Validation for migration: t1usr_migration
# Auto-generated by Terraform. Run before executing switchover.
set -e
MIGRATION_ID="ocid1.odmsmigration.oc1.iad.amaaaaaarsnyneya5ue4j75433o2tv42r3aoznkeol3o6gykinairlsldb5q"
MAX_LAG=30
echo "============================================"
echo " Pre-Cutover Validation: t1usr_migration"
echo "============================================"
echo ""
...
TGT_ID="ocid1.odmsconnection.oc1.iad.amaaaaaarsnyneyab3b5qypl54b3bxvofwti65ehk6j6viwfdtukmowhlj6a"
TGT_STATE=$(oci database-migration connection get --connection-id "$TGT_ID" \
  --query 'data."lifecycle-state"' --raw-output 2>/dev/null)
echo "  Target connection state: $TGT_STATE"
echo ""
echo "============================================"
echo " All pre-cutover checks passed for t1usr_migration"
